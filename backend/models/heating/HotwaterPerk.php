...
/**
 * This is the model class for table "hotwaterPerk".
 *
 ...
 */
class HotwaterPerk extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasMany(HeatingBook::className(), ['hotwater_perk_id' => 'hotwater_perk_id']);
    }
}
